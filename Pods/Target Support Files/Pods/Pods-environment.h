...
// DWNavMenu
#define COCOAPODS_POD_AVAILABLE_DWNavMenu
#define COCOAPODS_VERSION_MAJOR_DWNavMenu 1
#define COCOAPODS_VERSION_MINOR_DWNavMenu 0
#define COCOAPODS_VERSION_PATCH_DWNavMenu 4
